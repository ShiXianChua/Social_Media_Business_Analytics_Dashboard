...
def init_dashboard(server):
    ...
    app = dash.Dash(server=server, routes_pathname_prefix='/aa/', external_stylesheets=external_stylesheets)
    ...
    def parse_contents(contents):
        ...
        try:
            ...
            FbCountryfig = px.bar(FbCountrydf, x="Percentage", y='Top Countries',
                                  title='Facebook Page Likes by Top Countries')
            ...
            IgCountryfig = px.bar(IgCountrydf, x="Percentage", y='Top Countries',
                                  title='Instagram Followers by Top Countries')
