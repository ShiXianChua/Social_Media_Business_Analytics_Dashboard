...
def init_dashboard(server):
    ...
    app = dash.Dash(server=server, routes_pathname_prefix='/sa_insta/', external_stylesheets=external_stylesheets)
    ...
    def parse_contents(contents):
        ...
        return html.Div([
            dbc.Container([
                ...
                dbc.Row([
                    dbc.Col(
                        [html.Img(src="https://workingwithdog.com/wp-content/uploads/2016/05/new_instagram_logo.jpg",
                                  width="30px", height="30px", style={"float": "left", "margin-right": 5}),
                         html.H5("Instagram Account: " + instaName, style={'font-style': 'italic'})]),
                ]),
                dbc.Row([
